...
export class UserService {
   ...
   * @throws ApiError
   */
  public static findByUsername(userName?: string): CancelablePromise<UserDTO> {
   ...
   * @throws ApiError
   */
  public static addFriend(username?: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static unfriend(username: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static getPendingFriendRequests(): CancelablePromise<
    Array<FriendRequestDTO>
  > {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static outgoingFriendRequests(): CancelablePromise<
    Array<FriendRequestDTO>
  > {
    return __request(OpenAPI, {
      method: "GET",
