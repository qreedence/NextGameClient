...
export class AuthService {
   ...
   * @throws ApiError
   */
  public static loginUser(requestBody: LoginDTO): CancelablePromise<any> {
   ...
   * @throws ApiError
   */
  public static externalAuthComplete(tokenId?: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static registerUser(requestBody: RegisterDTO): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "POST",
