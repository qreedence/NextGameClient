...
//   const validPassword = validationService.validatePassword(
//     changePasswordDTO.newPassword
//   );
//   const passwordsMatch = validationService.validatePasswordsMatch(
//     changePasswordDTO.newPassword,
//     confirmNewPassword
//   );
...
//         className="fieldset w-md bg-base-100 border border-base-300 p-4 rounded-box"
//       >
//         <Input
//           id={"currentPassword"}
...
//         />
//         {errors.length > 0 && <AlertError errorMessages={errors} />}
//         <button
//           type="submit"
//           disabled={isPending || success}
//           className="btn btn-neutral"
//         >
//           {isPending && !success ? "Updating..." : "Save Changes"}
//           {success && <Check className="ml-2" />}
//         </button>
//       </form>
//     );
//   }
