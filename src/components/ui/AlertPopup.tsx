...
const AlertPopup = ({title, description, continueAction, cancelAction}:AlertPopupProps) => {
    return (
        <AlertDialog>
            <AlertDialogContent>
            <AlertDialogHeader>
            ...
            <AlertDialogFooter>
               {cancelAction && <AlertDialogCancel onClick={cancelAction}>Cancel</AlertDialogCancel> } 
